  ...
  v-card-text.text-xs-left
    .description.mb-3
      p.mb-2
        | 昨年もありがとうございました。
        br
        | お陰様で大変面白い一年となったので、苦境を乗り越えてもっと面白い一年となるよう楽しんでまいります。
        br
        | 本コンテンツのごとく、言語（言葉、コトダマ）で勝負です。
      p
        | 昨年は年賀コンテンツがなかなか思いつかず、入浴中に降ってきたアイデアがここまで育ちました。
        br
        | 亥年に引き続きガチャっぽいコンテンツなので、いっぱい引いてみてください。
    p.mb-3
      | 令和2年1月1日  岩淵 勇樹
